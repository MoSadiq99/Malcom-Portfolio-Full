...
<?php include('uploadPortraits.php'); ?>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><?php echo $row['orderGallery']; ?></td>
                                    <td> <a href="update_page.php?id=<?php echo $row['idGallery']; ?>" class="btn btn-success">Update</a> </td>
                                    <td> <a href="delete_page.php?id=<?php echo $row['idGallery']; ?>" class="btn btn-danger">delete</a> </td>
                                </tr>
                        <?php
                ...
                <!-- Modal -->
                <form action="uploadPortraits.php" method="POST" enctype="multipart/form-data">
