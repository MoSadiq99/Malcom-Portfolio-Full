        ...
        if ($fileError === 0) {
            ...
            if ($fileSize < $fileMaxFileSize) {
                ...
                if (empty($imageTitle) || empty($imageDesc)) {
                    ...
                    $selectSql = "SELECT * FROM naturegallery;";
                    ...
                    $sql = "INSERT INTO naturegallery (titleImg, descImg, fullNameImg, orderImg) VALUES (?, ?, ?, ?);";
                    ...
                    if (!mysqli_stmt_prepare($stmt, $sql)) {
                        ...
                        header("location: adminNature.php?insert_msg=Your image has been inserted successfully");
                    }
